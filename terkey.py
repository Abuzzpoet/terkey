...
if __name__=='__main__':
    ...
    while t.is_alive():
        for i in "-\|/-\|/":
            ...
            sleep(0.1)
    banner()
    print(c+'Silahkan hubungi '+a+'https://instagram.com/rajifarmansyah'+c+' jika ada yang mau di bicarakan terkait script ini, juga tutorial di YouTube Drawl Nagi. :v\nTerimakasih ^_^')
